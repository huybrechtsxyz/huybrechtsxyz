...
using Flow = Huybrechts.App.Features.Setup.SetupNoSerieFlow;

namespace Huybrechts.Web.Pages.Features.Setup.NoSerie;
...
public class CreateModel : PageModel
{
    ...
    public CreateModel(IMediator mediator, IValidator<Flow.CreateCommand> validator)
    {
        ...
        TypeOfOptions = new SelectList(SetupNoSerieHelper.AllowedTypeOfValues);
        Data = new();
    }

    public void OnGet()
    {
        Data = Flow.SetupNoSerieHelper.CreateNew();
    }
