...
public record _z_PlatformRate : Entity, IEntity
{
    ...
    /// <summary>
    /// Foreign key referencing the PlatformService table.
    /// This links the rate to a specific service offered on the platform, allowing for accurate pricing.
    /// </summary>
    [Required]
    ...
    /// <summary>
    /// Navigation property for the associated PlatformService.
    /// Provides access to details about the service this rate applies to.
    /// </summary>
    public PlatformService PlatformService { get; set; } = new();
    ...
    /// <summary>
    /// Foreign key referencing the PlatformProduct entity.
    /// Links the rate to a specific product category, ensuring accurate pricing across products.
    /// </summary>
    [Required]
