        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviewText = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false, comment: "Gets or sets the first characters of the markdown content for the wiki page."),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Gets or sets the markdown content for the wiki page."),
