        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true, comment: "A brief description providing details about the product."),
                    Category = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true, comment: "Category of the product"),
                    CostDriver = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true, comment: "The cost driver or factor that influences the pricing of the product."),
                    CostBasedOn = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true, comment: "Parameters or metrics on which the cost of the product is based."),
                    Limitations = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true, comment: "Limitations or constraints related to the product."),
                    AboutURL = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true, comment: "URL linking to additional information about the product."),
                    PricingURL = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true, comment: "URL providing pricing information for the product."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true, comment: "The category or family of the service, helping to classify it among similar offerings."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Remark = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "Additional remarks or comments about the project design."),
                    Tags = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "Keywords or categories for the design"),
                    State = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false, comment: "Gets or sets the current state of the project design."),
                    Reason = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true, comment: "Gets or sets the reason for the current state of the design."),
                    Environment = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true, comment: "The environment in which the project design is implemented."),
                    Version = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true, comment: "Design version"),
                    Dependencies = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "List of dependencies for the design"),
                    Priority = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true, comment: "Gets or sets the priority of the project."),
                    Risk = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true, comment: "Gets or sets the risk of the project."),
                    Rating = table.Column<int>(type: "int", nullable: true, comment: "Gets or sets the rating of the project, reflecting its priority, quality, or stakeholder approval."),
                    SearchIndex = table.Column<string>(type: "nvarchar(450)", nullable: true, comment: "This field will store the normalized, concatenated values for searching"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCalculating = table.Column<bool>(type: "bit", nullable: false, comment: "Gets or sets if the project simulation is being calculated on this moment."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitFactor = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false, comment: "Conversion factor for the unit rate, translating platform units to standard units."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RetailPrice = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false, comment: "Retail price."),
                    UnitPrice = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false, comment: "Unit price."),
                    MinimumUnits = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false, comment: "Tier minimum units."),
                    UnitOfMeasure = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false, comment: "Unit of measure."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sequence = table.Column<int>(type: "int", nullable: false, comment: "Gets or sets the sequence order of this component within its parent design or component."),
                    Name = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false, comment: "Gets or sets the name of the component."),
                    Description = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true, comment: "Gets or sets the description of the component."),
                    Remark = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "Gets or sets any additional remarks or notes about the component."),
                    SearchIndex = table.Column<string>(type: "nvarchar(450)", nullable: true, comment: "A normalized search index to optimize searching through components."),
                    ComponentLevel = table.Column<int>(type: "int", nullable: false, comment: "Specifies the level of the component (e.g., Component, Configuration, Module, Variant)."),
                    VariantType = table.Column<int>(type: "int", nullable: false, comment: "Specifies the type of variant for this component (Standard, Option, Exceptional)."),
                    Proposal = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true, comment: "Gets or sets the proposal associated with the component."),
                    Account = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true, comment: "Gets or sets the account under which this component is managed."),
                    Organization = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true, comment: "Gets or sets the organization under which this component is managed."),
                    OrganizationalUnit = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true, comment: "Gets or sets the account under which this component is managed."),
                    Location = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true, comment: "Gets or sets the location associated with the component."),
                    Group = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true, comment: "Gets or sets the group to which this component belongs."),
                    Environment = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true, comment: "Gets or sets the environment associated with the component."),
                    Responsible = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true, comment: "Gets or sets the responsible to which this component belongs."),
                    OwnershipPercentage = table.Column<int>(type: "int", nullable: false, comment: "Gets or sets the percentage of ownership for this component."),
                    SourceType = table.Column<int>(type: "int", nullable: false, comment: "Specifies the source type of this component (None, Platform)."),
                    Source = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "Optional field to store the source of this component."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sequence = table.Column<int>(type: "int", nullable: false, comment: "Gets or sets the sequence order of this unit within its parent scenario."),
