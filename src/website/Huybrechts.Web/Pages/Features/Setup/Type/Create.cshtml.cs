...
using Flow = Huybrechts.App.Features.Setup.SetupTypeFlow;

namespace Huybrechts.Web.Pages.Features.Setup.Type;
...
public class CreateModel : PageModel
{
    ...
    public CreateModel(IMediator mediator, IValidator<Flow.CreateCommand> validator)
    {
        ...
        TypeOfOptions = new SelectList(SetupTypeHelper.AllowedTypeOfValues);
        Data = new();
    }

    public void OnGet()
    {
        Data = Flow.SetupTypeHelper.CreateNew();
    }
