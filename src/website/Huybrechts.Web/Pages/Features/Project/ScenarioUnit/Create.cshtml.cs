...
public class CreateModel : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync(Ulid ProjectScenarioId)
    {
        try
        {
            Flow.CreateQuery message = new() { ProjectScenarioId = ProjectScenarioId };
            ...
            if (result.IsFailed)
                return RedirectToPage(nameof(Index), new { ProjectScenarioId });
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        try
        {
            ...
            return RedirectToPage(nameof(Index), new { Data.ProjectScenarioId });
        }
        catch (Exception ex)
        {
