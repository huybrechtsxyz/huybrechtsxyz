...
using Flow = Huybrechts.App.Features.Project.ProjectQuantityFlow;

namespace Huybrechts.Web.Pages.Features.Project.Quantity;
...
public class CreateModel : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync(Ulid ProjectInfoId)
    {
        try
        {
            ...
            if (result.IsFailed)
                return RedirectToPage(nameof(Index), new { ProjectInfoId });
