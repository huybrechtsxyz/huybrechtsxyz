...
public class TenantDeleteModel : PageModel
{
    ...
    public TenantDeleteModel(ApplicationUserManager userManager, ApplicationTenantManager tenantManager)
    {
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        {
            StatusMessage = "Unexpected error when trying to delete tenant.";
            return Page();
        }

        await _tenantManager.DeleteTenantAsync(user, Input);
