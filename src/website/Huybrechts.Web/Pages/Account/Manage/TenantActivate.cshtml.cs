...
public class TenantActivateModel : PageModel
{
    ...
    public TenantActivateModel(ApplicationUserManager userManager, ApplicationTenantManager tenantManager)
    {
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        {
            StatusMessage = "Unexpected error when trying to activate tenant.";
            return Page();
        }

        await _tenantManager.ActivateTenantAsync(user, Input);
