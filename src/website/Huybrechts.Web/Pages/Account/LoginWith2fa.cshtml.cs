...
namespace Huybrechts.Web.Pages.Account
{
    public class LoginWith2faModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Display(Name = nameof(TwoFactorCode), Prompt = nameof(TwoFactorCode), ResourceType = typeof(AccountViewModels))]
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Display(Name = nameof(RememberMachine), Prompt = nameof(RememberMachine), ResourceType = typeof(AccountViewModels))]
