        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true, comment: "Description of the platform"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false, comment: "Primary Key"),
                    PlatformInfoId = table.Column<string>(type: "TEXT", nullable: false, comment: "PlatformInfo FK"),
                    Name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false, comment: "Name of the region"),
                    Label = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false, comment: "Label of the region"),
                    Description = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true, comment: "Description of the region"),
