        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false, comment: "The name of the product or service offered by the platform."),
                    Label = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false, comment: "A label representing the product, often used in the user interface."),
                    Category = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true, comment: "The category or family of the product, helping to classify it among similar offerings."),
                    Description = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true, comment: "A brief description providing additional details about the product."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false, comment: "The name of the service offered by the platform."),
                    Label = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false, comment: "A label representing the service, often used for display purposes."),
                    Description = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true, comment: "A brief description providing details about the service."),
                    CostDriver = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true, comment: "The cost driver or factor that influences the pricing of the service."),
                    CostBasedOn = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true, comment: "Parameters or metrics on which the cost of the service is based."),
                    Limitations = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true, comment: "Limitations or constraints related to the service."),
                    AboutURL = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true, comment: "URL linking to additional information about the service."),
                    PricingURL = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true, comment: "URL providing pricing information for the service."),
                    ServiceId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true, comment: "Original identifier used to reference the service."),
                    ServiceName = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true, comment: "Original name of the service used for external identification."),
                    ServiceFamily = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true, comment: "Service family or category"),
                    Size = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true, comment: "Size or pricing tier associated with the service."),
