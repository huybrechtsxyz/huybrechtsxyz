        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Variable = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false, comment: "The variable name used in the metrics calculations for this component unit."),
                    Expression = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true, comment: "The formula used to calculate the value of the variable for this component unit."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RetailCost = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: false, comment: "Internal retail cost in the specified currency."),
                    UnitCost = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: false, comment: "Internal unit cost per service unit in the specified currency."),
                    OwnRetailCost = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: false, comment: "Ownership-adjusted retail cost in the specified currency."),
                    OwnUnitCost = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: false, comment: "Ownership-adjusted unit cost per service unit in the specified currency."),
                    TenantId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false, comment: "The tenant identifier"),
                    CreatedDT = table.Column<DateTime>(type: "TEXT", nullable: false, comment: "Date time created"),
                    ModifiedDT = table.Column<DateTime>(type: "TEXT", nullable: true, comment: "Modified time created"),
                    TimeStamp = table.Column<byte[]>(type: "BLOB", rowVersion: true, nullable: true, defaultValueSql: "CURRENT_TIMESTAMP")
