        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SearchIndex = table.Column<string>(type: "text", nullable: true, comment: "This field will store the normalized, concatenated values for searching"),
                    State = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false, comment: "Gets or sets the current state of the project."),
                    Reason = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true, comment: "Gets or sets the reason for the current state of the project."),
                    StartDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "Gets or sets the start date for the project."),
                    TargetDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "Gets or sets the target completion date for the project."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Code = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    Name = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    TranslatedName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    Description = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    SearchIndex = table.Column<string>(type: "text", nullable: true, comment: "This field will store the normalized, concatenated values for searching"),
                    TenantId = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false, comment: "Gets or sets the tenant identifier."),
                    CreatedDT = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: "Date time created"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Code = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false, comment: "A unique code representing the unit, standardized across all instances."),
                    Name = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false, comment: "The unique name of the unit within its type."),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "character varying(26)", nullable: false, comment: "Gets or sets the primary key for the entity."),
                    ProjectInfoId = table.Column<string>(type: "character varying(26)", nullable: false, comment: "Gets or sets the unique identifier for the project associated with this bill of quantities."),
                    Name = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false, comment: "Gets or sets the name of the bill of quantities."),
                    Description = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true, comment: "Gets or sets a description of the bill of quantities."),
                    Remark = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true, comment: "Gets or sets any additional remarks for the bill of quantities."),
                    Tags = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true, comment: "Gets or sets the tags associated with the bill of quantities."),
                    SearchIndex = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true, comment: "Gets or sets the search index for the bill of quantities."),
                    TenantId = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false, comment: "Gets or sets the tenant identifier."),
                    CreatedDT = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: "Date time created"),
                    CreatedBy = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true, comment: "Gets or sets the ID of the user who created the entity."),
                    ModifiedDT = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "Gets or sets the last modified date and time for the entity."),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "character varying(26)", nullable: false, comment: "Gets or sets the primary key for the entity."),
                    SetupLanguageId = table.Column<string>(type: "character varying(26)", nullable: true),
                    SetupCurrencyId = table.Column<string>(type: "character varying(26)", nullable: true),
                    Code = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    Name = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    TranslatedName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SetupUnitId = table.Column<string>(type: "character varying(26)", nullable: true, comment: "The ID of the measuring unit used for this component."),
                    ProjectQuantityId = table.Column<string>(type: "character varying(26)", nullable: true, comment: "Gets or sets the unique identifier for the Project Quantity."),
                    ...
                    Description = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true, comment: "Gets or sets the description of the unit."),
                    Variable = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true, comment: "The variable name used in the metrics calculations for this component unit."),
                    Category = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true, comment: "Category of the component unit (example: forfait, per unit, ...)"),
                    Expression = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true, comment: "The formula used to calculate the value of the quantity for this component unit."),
                    Quantity = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: false, comment: "Gets or sets the quantity of the unit used."),
                    SalesPrice = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: false, comment: "Gets or sets the sales price for a unit."),
                    RetailPrice = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: false, comment: "Gets or sets the standard price for a unit."),
                    UnitPrice = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: false, comment: "Gets or sets the actual price you pay for a unit."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlatformServiceId = table.Column<string>(type: "character varying(26)", nullable: false, comment: "Foreign key referencing the PlatformService entity."),
                    PlatformRateId = table.Column<string>(type: "character varying(26)", nullable: false, comment: "Foreign key referencing the PlatformProduct entity."),
                    UnitDescription = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true, comment: "Gets or sets the description of the unit."),
                    UnitCategory = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true, comment: "Category of the component unit (example: forfait, per unit, ...)"),
                    CurrencyCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false, comment: "Currency code."),
                    UnitOfMeasure = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false, comment: "Unit of measure."),
                    ...
                    SalesAmount = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false, comment: "Internal retail cost in the specified currency."),
                    RetailAmount = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false, comment: "Internal retail cost in the specified currency."),
                    UnitAmount = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false, comment: "Internal unit cost per service unit in the specified currency."),
                    OwnSalesAmount = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false, comment: "The sales revenue adjusted for the ownership percentage."),
                    OwnRetailAmount = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false, comment: "Ownership-adjusted retail cost in the specified currency."),
                    OwnUnitAmount = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false, comment: "Ownership-adjusted unit cost per service unit in the specified currency."),
                    TenantId = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false, comment: "Gets or sets the tenant identifier."),
                    CreatedDT = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: "Date time created"),
                    CreatedBy = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true, comment: "Gets or sets the ID of the user who created the entity."),
                    ModifiedDT = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "Gets or sets the last modified date and time for the entity."),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlatformRate_TenantId_PlatformInfoId_PlatformProductId_Vali~",
                table: "PlatformRate",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlatformRateUnit_TenantId_PlatformInfoId_PlatformProductId_~",
                table: "PlatformRateUnit",
